...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('type', models.CharField(choices=[('1', 'Facebook'), ('2', 'Instagram'), ('3', 'Twitter')], max_length=12, null=True)),
        ...
        migrations.AddField(
            model_name='user',
            name='place',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='current_location', to='user_mgmt.location'),
        ),
        migrations.AddField(
            model_name='user',
